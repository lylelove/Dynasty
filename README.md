...
1. **明制宗藩系统（世袭罔替）**
   - 亲王（如「秦王」）、郡王嫡长子袭爵**世袭罔替**，永不降等；余子降一等分封。
   - 郡王以下依次为镇国将军、辅国将军、奉国将军、镇国中尉、辅国中尉、奉国中尉，至奉国中尉后世代不再降，全体成年宗室皆可繁衍。
   - 封国无后时，触发绝嗣判定，支持收继侄嗣以延续香火；再无则除国。
...
### V1.00 (亡国后翻阅国史与结束流程重塑)
- **新增**：游戏结束弹窗改为三按钮——**重新开始**（重置回开始页）、**翻阅国史**（或点 X 关闭，留在主界面查阅本局史料）、**导出提示词**（弹出国史 AI 提示词框）。
- **新增**：**翻阅国史模式**——关闭结束弹窗后，主界面下方显示「重新开始」与「一键导出国史提示词」，可继续翻阅本局数据并导出史书 Prompt，再随时重开新局。
- **优化**：庙号、谥号与命名生成逻辑，强化谥号选取标准与历史质感。

---

### V1.10 (宗藩系统大修：明制世袭罔替 - 本次更新)
- **重做**：袭爵制度由唐制九等爵改为**明制宗藩八等**——亲王、郡王、镇国将军、辅国将军、奉国将军、镇国中尉、辅国中尉、奉国中尉。
- **新增**：**世袭罔替**——亲王/郡王嫡长子（含代位、过继）袭同封同爵，永不降等；余子降一等；将军中尉诸子皆降一等，至奉国中尉世代不降。
- **新增**：**全体成年宗室可育**——生育率按爵位递减（亲王 > 郡王 > 将军 > 中尉），配合软/硬人口上限与裁剪阈值控制宗室规模。
- **优化**：谥号规格随爵而异——亲王一字谥（秦愍王）、郡王双字谥（永兴恭定王）、将军中尉无谥；亲王嫡长称「王世子」、郡王嫡长称「王长子」。
- **优化**：将军中尉无封号，「国别」栏自动归入所属王府支系。
