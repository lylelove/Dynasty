...
class ResourcesMixin:
    ...
    def init_tang_resources(self):
        ...
        self.emperor_miaohao_decline = ["哀宗", "昭宗", "恭宗", "襄宗", "殇宗", "携宗", "怀宗", "思宗", "毅宗", "威宗"]
        ...
        # 皇帝尊号碎片，按义类分池（仿唐宋上尊号礼制：登基初上二段，在位屡加）
        self.zunhao_theme_pools = {
            # 天命：受命于天，初号首段例用
            "tianming": ["应天", "法天", "体天", "继天", "绍天", "奉天", "顺天",
                         "承天", "统天", "宪天", "景命", "凝命", "启运", "肇纪",
                         "垂统", "开天", "光天"],
            # 道蕴：圣哲玄远
            "daoyun": ["至道", "体道", "弘道", "显道", "述道", "玄元", "体元",
                       "大圣", "圣神", "睿圣", "中和", "太和", "法古", "绥猷"],
            # 文治：崇文昭明
            "wenzhi": ["崇文", "睿文", "昭文", "文明", "大明", "昭明", "熙载",
                       "咸熙", "建中", "至治", "淳化", "雍熙"],
            # 武功：神武英烈
            "wugong": ["神功", "神武", "圣武", "英武", "睿武", "耀武", "威烈",
                       "定功", "隆兴", "文武"],
            # 德行：孝德钦明
            "dexing": ["敦孝", "广孝", "至孝", "钦明", "昭德", "明德", "彰信",
                       "敦叙", "端拱", "景福", "嘉庆", "泰定"],
        }
        # 初号第二段与在位加号所用的功德义类（首段天命另池）
        self.zunhao_merit_themes = ("daoyun", "wenzhi", "wugong", "dexing")
